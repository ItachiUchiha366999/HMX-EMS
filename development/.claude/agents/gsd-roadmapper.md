...
Reference full template: `/workspace/development/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspace/development/.claude/get-shit-done/templates/state.md`.
