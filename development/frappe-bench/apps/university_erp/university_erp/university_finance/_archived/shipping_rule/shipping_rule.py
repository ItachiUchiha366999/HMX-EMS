...
class ShippingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.shipping_rule_condition.shipping_rule_condition import (
			ShippingRuleCondition,
		)
		from university_erp.university_finance.doctype.shipping_rule_country.shipping_rule_country import (
			ShippingRuleCountry,
		)
