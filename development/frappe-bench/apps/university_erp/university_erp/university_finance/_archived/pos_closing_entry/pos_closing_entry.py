...
from university_erp.university_finance.controllers.status_updater import StatusUpdater
...
class POSClosingEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.pos_closing_entry_detail.pos_closing_entry_detail import (
			POSClosingEntryDetail,
		)
		from university_erp.university_finance.doctype.pos_closing_entry_taxes.pos_closing_entry_taxes import (
			POSClosingEntryTaxes,
		)
		from university_erp.university_finance.doctype.pos_invoice_reference.pos_invoice_reference import (
			POSInvoiceReference,
		)
