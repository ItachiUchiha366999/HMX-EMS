...
class Dunning(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.overdue_payment.overdue_payment import OverduePayment
	...
	def set_party_details(self):
		from university_erp.university_finance.party import _get_party_details
