...
class PromotionalScheme(Document):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.campaign_item.campaign_item import CampaignItem
		from university_erp.university_finance.doctype.customer_group_item.customer_group_item import CustomerGroupItem
		from university_erp.university_finance.doctype.customer_item.customer_item import CustomerItem
		from university_erp.university_finance.doctype.pricing_rule_brand.pricing_rule_brand import PricingRuleBrand
		from university_erp.university_finance.doctype.pricing_rule_item_code.pricing_rule_item_code import (
			PricingRuleItemCode,
		)
		from university_erp.university_finance.doctype.pricing_rule_item_group.pricing_rule_item_group import (
			PricingRuleItemGroup,
		)
		from university_erp.university_finance.doctype.promotional_scheme_price_discount.promotional_scheme_price_discount import (
			PromotionalSchemePriceDiscount,
		)
		from university_erp.university_finance.doctype.promotional_scheme_product_discount.promotional_scheme_product_discount import (
			PromotionalSchemeProductDiscount,
		)
		from university_erp.university_finance.doctype.sales_partner_item.sales_partner_item import SalesPartnerItem
		from university_erp.university_finance.doctype.supplier_group_item.supplier_group_item import SupplierGroupItem
		from university_erp.university_finance.doctype.supplier_item.supplier_item import SupplierItem
		from university_erp.university_finance.doctype.territory_item.territory_item import TerritoryItem
