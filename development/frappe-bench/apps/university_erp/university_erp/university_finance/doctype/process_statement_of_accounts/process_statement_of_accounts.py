...
from university_erp.university_finance._erpnext_compat import get_company_currency
from university_erp.university_finance.party import get_party_account_currency
from university_erp.university_finance.report.accounts_receivable.accounts_receivable import execute as get_ar_soa
from university_erp.university_finance.report.accounts_receivable_summary.accounts_receivable_summary import (
	execute as get_ageing,
)
from university_erp.university_finance.report.general_ledger.general_ledger import execute as get_soa
...
class ProcessStatementOfAccounts(Document):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.process_statement_of_accounts_cc.process_statement_of_accounts_cc import (
			ProcessStatementOfAccountsCC,
		)
		from university_erp.university_finance.doctype.process_statement_of_accounts_customer.process_statement_of_accounts_customer import (
			ProcessStatementOfAccountsCustomer,
		)
		from university_erp.university_finance.doctype.psoa_cost_center.psoa_cost_center import PSOACostCenter
		from university_erp.university_finance.doctype.psoa_project.psoa_project import PSOAProject
