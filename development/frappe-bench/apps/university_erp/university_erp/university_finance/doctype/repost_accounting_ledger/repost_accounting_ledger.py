...
class RepostAccountingLedger(Document):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.repost_accounting_ledger_items.repost_accounting_ledger_items import (
	...
	def generate_preview(self):
		from university_erp.university_finance.report.general_ledger.general_ledger import get_columns as get_gl_columns
	...
	def on_submit(self):
		if len(self.vouchers) > 5:
			...
			frappe.enqueue(
				method="university_erp.university_finance.doctype.repost_accounting_ledger.repost_accounting_ledger.start_repost",
...
def start_repost(account_repost_doc=str) -> None:
	from university_erp.university_finance.general_ledger import make_reverse_gl_entries
