...
class TaxWithholdingCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.tax_withholding_account.tax_withholding_account import (
			TaxWithholdingAccount,
		)
		from university_erp.university_finance.doctype.tax_withholding_rate.tax_withholding_rate import TaxWithholdingRate
