...
from university_erp.university_finance.doctype.loyalty_program.loyalty_program import validate_loyalty_points
from university_erp.university_finance.doctype.payment_request.payment_request import make_payment_request
from university_erp.university_finance.doctype.sales_invoice.sales_invoice import (
	SalesInvoice,
	get_mode_of_payment_info,
	update_multi_mode_option,
)
from university_erp.university_finance.party import get_due_date, get_party_account
from university_erp.university_finance.controllers.queries import item_query as _item_query
# Stubbed: from erpnext.stock.doctype.serial_no.serial_no import get_serial_nos
# Stubbed: from erpnext.stock.stock_ledger import is_negative_stock_allowed
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from university_erp.university_finance.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from university_erp.university_finance.doctype.pricing_rule.utils import update_coupon_code_count
