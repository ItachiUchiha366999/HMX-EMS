...
from university_erp.university_finance.utils import validate_field_number
...
class CostCenter(NestedSet):
	...
	def autoname(self):
		from university_erp.university_finance.utils import get_autoname_with_number
	...
	def before_rename(self, olddn, newdn, merge=False):
		...
		# Stubbed: from erpnext.setup.doctype.company.company import get_name_with_abbr
