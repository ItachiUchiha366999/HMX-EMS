...
from university_erp.university_finance.general_ledger import (
...
from university_erp.university_finance.utils import get_account_currency, get_fiscal_year, update_voucher_outstanding
# Stubbed: from erpnext.assets.doctype.asset.asset import is_cwip_accounting_enabled
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.advance_tax.advance_tax import AdvanceTax
		...
		from university_erp.university_finance.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from university_erp.university_finance.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from university_erp.university_finance.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from university_erp.university_finance.doctype.tax_withheld_vouchers.tax_withheld_vouchers import TaxWithheldVouchers
		# Stubbed: from erpnext.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			# Stubbed: from erpnext.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
...
def make_inter_company_sales_invoice(source_name, target_doc=None):
	from university_erp.university_finance.doctype.sales_invoice.sales_invoice import make_inter_company_transaction
