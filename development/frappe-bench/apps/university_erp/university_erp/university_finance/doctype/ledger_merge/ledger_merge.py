...
from university_erp.university_finance.doctype.account.account import merge_account
...
class LedgerMerge(Document):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.ledger_merge_accounts.ledger_merge_accounts import (
			LedgerMergeAccounts,
		)
