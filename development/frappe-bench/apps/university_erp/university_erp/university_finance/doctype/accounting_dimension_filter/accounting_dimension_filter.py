...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from university_erp.university_finance.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount
