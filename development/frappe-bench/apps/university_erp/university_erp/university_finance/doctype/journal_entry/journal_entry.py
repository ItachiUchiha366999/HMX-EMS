...
from university_erp.university_finance.deferred_revenue import get_deferred_booking_accounts
from university_erp.university_finance.doctype.invoice_discounting.invoice_discounting import (
...
from university_erp.university_finance.party import get_party_account
...
# Stubbed: from erpnext.assets.doctype.asset_depreciation_schedule.asset_depreciation_schedule import get_depr_schedule
from university_erp.university_finance.controllers.accounts_controller import AccountsController
from university_erp.university_finance._erpnext_compat import get_exchange_rate as _get_exchange_rate
...
class JournalEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.journal_entry_account.journal_entry_account import JournalEntryAccount
...
class JournalEntryTaxWithholding:
	...
	def _calculate_net_total(self):
		from university_erp.university_finance.report.general_ledger.general_ledger import get_account_type_map
...
def get_default_bank_cash_account(company, account_type=None, mode_of_payment=None, account=None):
	from university_erp.university_finance.doctype.sales_invoice.sales_invoice import get_bank_cash_account
