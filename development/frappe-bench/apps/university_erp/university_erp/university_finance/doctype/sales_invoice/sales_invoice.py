...
from university_erp.university_finance.doctype.tax_withholding_category.tax_withholding_category import (
	get_party_tax_withholding_details,
)
from university_erp.university_finance.general_ledger import get_round_off_account_and_cost_center
from university_erp.university_finance.party import get_due_date, get_party_account, get_party_details
from university_erp.university_finance.utils import (
	cancel_exchange_gain_loss_journal,
	get_account_currency,
	update_voucher_outstanding,
)
# Stubbed: from erpnext.assets.doctype.asset.depreciation import (
	# depreciate_asset,
...
# Stubbed: from erpnext.stock.doctype.serial_no.serial_no import get_serial_nos
...
class SalesInvoice(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.payment_schedule.payment_schedule import PaymentSchedule
		from university_erp.university_finance.doctype.pricing_rule_detail.pricing_rule_detail import PricingRuleDetail
		from university_erp.university_finance.doctype.sales_invoice_advance.sales_invoice_advance import SalesInvoiceAdvance
		from university_erp.university_finance.doctype.sales_invoice_item.sales_invoice_item import SalesInvoiceItem
		from university_erp.university_finance.doctype.sales_invoice_payment.sales_invoice_payment import SalesInvoicePayment
		from university_erp.university_finance.doctype.sales_invoice_timesheet.sales_invoice_timesheet import (
			SalesInvoiceTimesheet,
		)
		from university_erp.university_finance.doctype.sales_taxes_and_charges.sales_taxes_and_charges import (
			SalesTaxesandCharges,
		)
		# Stubbed: from erpnext.selling.doctype.sales_team.sales_team import SalesTeam
		# Stubbed: from erpnext.stock.doctype.packed_item.packed_item import PackedItem
	...
	def check_credit_limit(self):
		# Stubbed: from erpnext.selling.doctype.customer.customer import check_credit_limit
	...
	def set_pos_fields(self, for_validate=False):
		...
		# Stubbed: from erpnext.stock.get_item_details import get_pos_profile, get_pos_profile_item_details
	...
	def update_packing_list(self):
		if cint(self.update_stock) == 1:
			# Stubbed: from erpnext.stock.doctype.packed_item.packed_item import make_packing_list
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		from university_erp.university_finance.general_ledger import make_gl_entries, make_reverse_gl_entries
	...
	def get_gl_entries(self, warehouse_account=None):
		from university_erp.university_finance.general_ledger import merge_similar_entries
	...
	def apply_loyalty_points(self):
		from university_erp.university_finance.doctype.loyalty_point_entry.loyalty_point_entry import (
...
def get_list_context(context=None):
	from university_erp.university_finance.controllers.website_list_for_contact import get_list_context
...
def make_sales_return(source_name, target_doc=None):
	from university_erp.university_finance.controllers.sales_and_purchase_return import make_return_doc
...
def get_loyalty_programs(customer):
	...
	# Stubbed: from erpnext.selling.doctype.customer.customer import get_loyalty_programs
...
def create_dunning(source_name, target_doc=None, ignore_permissions=False):
	...
	def postprocess_dunning(source, target):
		from university_erp.university_finance.doctype.dunning.dunning import get_dunning_letter_text
