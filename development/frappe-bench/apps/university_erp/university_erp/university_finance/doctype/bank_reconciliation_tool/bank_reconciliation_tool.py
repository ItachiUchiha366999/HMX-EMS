...
from university_erp.university_finance._erpnext_compat import get_default_cost_center
from university_erp.university_finance.doctype.bank_transaction.bank_transaction import get_total_allocated_amount
from university_erp.university_finance.party import get_party_account
from university_erp.university_finance.report.bank_reconciliation_statement.bank_reconciliation_statement import (
	get_amounts_not_reflected_in_system,
	get_entries,
)
from university_erp.university_finance.utils import get_account_currency, get_balance_on
...
def auto_reconcile_vouchers(
	...
	if len(bank_transactions) > 10:
		for bank_transaction_batch in create_batch(bank_transactions, 1000):
			frappe.enqueue(
				method="university_erp.university_finance.doctype.bank_reconciliation_tool.bank_reconciliation_tool.start_auto_reconcile",
				queue="long",
