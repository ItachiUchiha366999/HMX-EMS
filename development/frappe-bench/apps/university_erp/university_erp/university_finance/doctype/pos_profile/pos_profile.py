...
class POSProfile(Document):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.pos_customer_group.pos_customer_group import POSCustomerGroup
		from university_erp.university_finance.doctype.pos_item_group.pos_item_group import POSItemGroup
		from university_erp.university_finance.doctype.pos_payment_method.pos_payment_method import POSPaymentMethod
		from university_erp.university_finance.doctype.pos_profile_user.pos_profile_user import POSProfileUser
