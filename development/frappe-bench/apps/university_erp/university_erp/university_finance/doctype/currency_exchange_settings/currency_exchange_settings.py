...
class CurrencyExchangeSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from university_erp.university_finance.doctype.currency_exchange_settings_details.currency_exchange_settings_details import (
			CurrencyExchangeSettingsDetails,
		)
		from university_erp.university_finance.doctype.currency_exchange_settings_result.currency_exchange_settings_result import (
