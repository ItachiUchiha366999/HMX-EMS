...
from university_erp.university_finance._exceptions import InvalidAccountCurrency, PartyDisabled, PartyFrozen
from university_erp.university_finance._erpnext_compat import temporary_flag
...
def set_taxes(
	...
	from university_erp.university_finance.doctype.tax_rule.tax_rule import get_party_details, get_tax_template
