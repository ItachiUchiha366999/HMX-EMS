...
# Forked from erpnext/controllers/taxes_and_totals.py for university_finance standalone use.
# Stock/selling/buying dependencies stripped.
...
from university_erp.university_finance.doctype.journal_entry.journal_entry import get_exchange_rate
from university_erp.university_finance.doctype.pricing_rule.utils import get_applied_pricing_rules
from university_erp.university_finance.controllers.accounts_controller import (
	validate_conversion_rate,
	validate_inclusive_tax,
	validate_taxes_and_charges,
)
# Stubbed: university does not use stock item details for tax templates
