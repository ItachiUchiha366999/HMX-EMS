...
Plans:
- [x] 03.4-01-PLAN.md — Seed comprehensive demo data (500+ students, 50+ faculty, financial transactions via university_finance, all modules populated) — re-run 2026-04-28: 510 students, 54 faculty, 800 GL entries, 22 demo users; seed script now re-run-safe with FY 2026-2027 + GL backfill
